...
public class CropCarrot implements ICropEntity {
	...
	public CropCarrot(World world, BlockPosition blockPosition) {
		this.world = world;
	...
	public ArrayList<ItemStack> doHarvest() {
		...
		Proxies.common.addBlockDestroyEffects(world, blockPos.x, blockPos.y, blockPos.z, Blocks.carrots, meta);
		return harvest;
	}
}
