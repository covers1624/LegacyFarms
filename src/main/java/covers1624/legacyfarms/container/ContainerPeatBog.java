...
public class ContainerPeatBog extends ContainerForestry {
	...
	public ContainerPeatBog(InventoryPlayer playerInventory, TilePlanter tilePlanter) {
		...
		InventoryUtils.addSlotToContainer(this, new InputSlot(planter, 0, 34, 35, new ItemStack(ForestryBlock.soil.block(), 1, 1)));
		InventoryUtils.addSlotToContainer(this, new InputSlot(planter, 1, 52, 35, new ItemStack(ForestryBlock.soil.block(), 1, 1)));
		InventoryUtils.addSlotToContainer(this, new InputSlot(planter, 2, 34, 53, new ItemStack(ForestryBlock.soil.block(), 1, 1)));
		InventoryUtils.addSlotToContainer(this, new InputSlot(planter, 3, 52, 53, new ItemStack(ForestryBlock.soil.block(), 1, 1)));
